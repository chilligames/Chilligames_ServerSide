...
class DB_model {
    ...
    async Add_purchases_history(Incomin_id, incomin_data, incoming_name_app) {
        try {
            ...
            await Connection.db("Chilligames").collection("Users").findOneAndUpdate({ '_id': new mongo_raw.ObjectID(Incomin_id) }, { $push: { ['Notifactions.Notifaction.' + incoming_name_app]: this.Raw_model_notifaction } });
